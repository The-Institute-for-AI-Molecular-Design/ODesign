...
from src.utils.permutation.utils import save_permutation_error
from src.api.model_interface import PermutationInput, GroundTruth
...
def run(
    ...
    **kwargs,
    ...
    Args:
        ...
        input_data (PermutationInput): A dictionary containing input features.
        ...
        if permute_by_pocket:
            ...
            permute_pred_indices, permuted_aligned_pred_coord, log_dict = (
                permute_pred_to_optimize_pocket_aligned_rmsd(
                    ...
                    true_coord_mask=ground_truth.coordinate_mask,
                    true_pocket_mask=pocket_mask,
                    true_ligand_mask=ligand_mask,
                    atom_entity_id=input_data.entity_mol_id,
                    atom_asym_id=input_data.mol_id,
                    mol_atom_index=input_data.mol_atom_index,
            ...
            output_dict, log_dict, permute_pred_indices, permute_label_indices = (
                correct_symmetric_chains(
                    pred_dict={**input_data.to_dict(), "coordinate": pred_coord},
